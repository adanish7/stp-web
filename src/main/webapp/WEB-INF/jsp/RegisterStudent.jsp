                        ...
                        <spring:form action="${pageContext.request.contextPath}/user/register/student" modelAttribute="user" accept-charset="utf-8" id="registration_form" name="registration_form">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <spring:errors path="firstName" cssClass="error"></spring:errors>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <spring:errors path="lastName" cssClass="error"></spring:errors>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <spring:errors path="phone" cssClass="error"></spring:errors>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <spring:input path="confirmPassword" type="password" name="password_confirm" value="" id="password_confirm"  />
                                    <spring:errors path="confirmPassword" cssClass="error"></spring:errors>
                                </div>
